...
public class PapagoService {
    public String test (String word){
        String clientId = "PEPM_fHm9t_41pr_7f2_";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "hW80jsZo99";//애플리케이션 클라이언트 시크릿값";
        ...
        String translatedText = responseObj.getJSONObject("message")
